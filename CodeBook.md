...
To obtain the summarised result set (getdata_006.txt) the data went through the following process:
	-original variable names for the measurements were changed to a standard form, all characters were changed tolower case, parentheses, dashes and commas were removed
